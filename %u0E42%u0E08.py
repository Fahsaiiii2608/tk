...
cl = LINETCR.LINE()
cl.login(token="EsQDNtlQ0jS3fKt33uN2.gYuYXybIjwoMHBNOpV+hSG.sDdsTzFq6t88Mqt8W5eemy5/pxad4B8leohWBJ1m+nk= ")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u1b2532c580622563a685b9e83effc7b2",mid]
self = ["u1b2532c580622563a685b9e83effc7b2",mid]
admin = "u1b2532c580622563a685b9e83effc7b2"
admsa = "u1b2532c580622563a685b9e83effc7b2"
owner = "u1b2532c580622563a685b9e83effc7b2"
adminMID = "u1b2532c580622563a685b9e83effc7b2"
Creator="u1b2532c580622563a685b9e83effc7b2"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#==============================================================================#
        if op.type == 15:
          if wait["bcommentOn"] == True:
            if op.param2 in Bots:
                return
            cl.sendText(op.param1,"Good Bye " + cl.getContact(op.param2).displayName +  str(["bcommentOn"]))
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            cl.sendMessage(c)
            cl.sendImageWithURL(op.param1,image)
