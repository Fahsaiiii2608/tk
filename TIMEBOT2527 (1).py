...
from googletrans import Translator
from gtts import gTTS
import time,random,sys,json,codecs,threading,glob,urllib,urllib2,urllib3,re,string,ast,os,subprocess,six,ast,pytz,requests,tempfile,wikipedia,tempfile


cl = LINETCR.LINE()
cl.login(token="EsIebcAl6FomLnHXYFxe./YLQOgIZ+sj+8fIgzRvH+G.fuj9edxf5zT5AIMNFY8luDrO4Ys6UD/FzwytVWluMUI=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EspipKq4VFX5hCTTnV56.tBbvHvKOjvPVuWvncrxXLG.QDvo99IVMqZpCr8ZYHxbsGzynI+8MA8Lm7rcpou970I=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Es645niLRbPpAQ5ogmu8.ghZnmC2ciegQIghsMM2+ka.yhLrwCUCLav7YIjtO5AHWXZtlxoJ5iV5RyKAkOzAo+M=")
ki2.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ufb296aa068b3fd227ff0588666b561fe","u4db055855928255a6f53054d0915f196","u187ccd31cd822041aa8861d29a6dbf28",mid]
self = ["ufb296aa068b3fd227ff0588666b561fe",mid]
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, "สวัสดีจ้า " + "[ " + Name + " ]" + "\nจะแอบอยู่ทำไมจ๊ะ ออกมาคุยกันหน่อยสิ อิอิ😁   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                    else:
                                        cl.sendText(op.param1, "สวัดดีจ้าคนหน้าตาดี " + "[ " + Name + " ]" + "\n นี้ก็อีกคน ! แอบอยู่ได้ อกมาจ้า ออกมาคุยกันหน่อย😁   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                else:
                                    cl.sendText(op.param1, "หวัดดีงับๆ  " + "☞ " + Name + " ☜" + "\n ออกมาเถอะ ไม่ตองแอบอ่านนะ ออกมาคุยกันจ้า😁   ")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
...
#====================================================
            ...
            elif msg.text in ["Myginfoid","ไอ���ีกลุ���ม ทั้งหมด"]:
     ...
     #                   ki8.acceptGroupInvitationByTicket(msg.to,Ticket)
      #                  ki9.acceptGroupInvitationByTicket(msg.to,Ticket)
       #                 ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ...
                        ki1.sendText(msg.to,"[SELF BOT\ทBy:TOMEBOTLINE]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki2.sendText(msg.to,"[ By:TOMEBOTLINE]")
...
set:changeowner
เปลี่ยนเจ้าของห้องสั่งแล้วส่งคอลแทคคนที่จะเป็นเ���้าของห้องคนต่อไปลงในกลุ่ม
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
...
#==============================================================================#
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Berhasil mengaktifkan Sider point")
                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Berhasil menonaktifkan Sider point")
                else:
                    cl.sendText(msg.to, "Setting Masih Mode Off\nMohon Maaf") 
#==============================================================================#
...
#========================================
                ...
                if wait["alwayRead"] == True: md+="╠❂➣ อ่าน : ✔ เปิดแล้ว\n"
                else:md+="╠❂➣ อ่าน : ❌ ปิดแล้ว\n"
                ...
                if wait["Protectcancl"] == True: md+="╠❂➣ Cancel : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ Cancel : ❌ ปิดิยู่\n"
                if wait["winvite"] == True: md+="╠❂➣ เชิญ: ✔ เปิดอยู่\n"
                else:md+="╠❂➣ เชิญ : ❌ ปิดอยู่\n"
                if wait["pname"] == True: md+="╠❂➣ ล็อคชื่อ : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ล็อคชื่อ : ❌ ปิดอยู่\n"
                if wait["contact"] == True: md+="╠❂➣ Contact : ✔ เปิดอยู่\n"
                else: md+="╠❂➣ Contact : ❌ ปิดอยู่\n"
                if wait["autoJoin"] == True: md+="╠❂➣ ออโต้เข้ากลุ่ม : ✔ เปิดอยู่\n"
                else: md +="╠❂➣ ออโต้เข้ากลุ่ม : ❌ ปิดอยู่\n"
                if wait["autoCancel"]["on"] == True:md+="╠❂➣ Group cancel :" + str(wait["autoCancel"]["members"]) + " ห้องที่เปิดใช้งาน\n"
                else: md+= "╠❂➣ Group cancel : ❌ ปิดอยู่\n"
                if wait["leaveRoom"] == True: md+="╠❂➣ ออโต้ ออกแชท : ✔ เปิดอยู่\n"
                else: md+="╠❂➣ ออโต้ ออกแชท: ❌ ปิดอยู่\n"
                if wait["timeline"] == True: md+="╠❂➣ ออโต้ แชร์ : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ออโต้ แชร์ : ❌ ปิดอยู่\n"
                if wait["clock"] == True: md+="╠❂➣ ชื่อ นาฬิกา : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ชื่อ นาฬิกา : ❌ ปิดอยู่\n"
                if wait["autoAdd"] == True: md+="╠❂➣ ออโต้ เพิ่มเพื่อน : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ออโต้ เพิ่มเพื่อน : ❌ ปิดอยู่\n"
                if wait["commentOn"] == True: md+="╠❂➣ ออโต้ คอมเม้น : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ออโต้ คอมเม้น : ❌ ปิดอยู่\n"
                if wait["Backup"] == True: md+="╠❂➣ ดึงกลับ : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ดึงกลับ : ❌ ปิดอยู่\n"
                if wait["qr"] == True: md+="╠❂➣ ป้องกัน QR : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ ป้องกัน QR : ❌ ปิดอยู่\n"
                if wait["Sider"] == True: md+="╠❂➣Sider : ✔ เปิดอยู่\n"
                else:md+="╠❂➣ Sider : ❌ ปิดอยู่\n"
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดหมด","Tome on","Phet all on"]:
                        cl.sendText(msg.to,"[SELF BOT]\n[By.❤🌷TOME↔BOTLINE🌷❤")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ปิดหมด","Tome off","Phet all off"]:
                        cl.sendText(msg.to,"[SELFBOT]\n[By.☬TOME↔BOTLINE]")
                        cl.sendText(msg.to,"Please wait......")
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                ...
                                pass
#                                    ki1.sendText(msg,to,"Nuke Finish")
#                                    ki2.sendText(msg,to,"
...
#            elif msg.text in ["คิก10","K10"]:
 ...
 #                       cl.sendText(msg.to,"😆เช็คจัง กลัวบอทหลุด ล่ะสิ😆")
                        ...
                        cl.sendText(msg.to,"OK I Online...")

            elif msg.text in ["/ออนไหม"]:
                        cl.sendText(msg.to,"บอททำงานต่อเนื่องอยู่จ้า")
...
#==============================================================================#
        if op.type == 17:
          if wait["Notifed"] == True:
            ...
            contact = cl.getContact(op.param2)
            image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1,"•สวัสดีจ้าคนมาใหม่ ↪️" + cl.getContact(op.param2).displayName + "↩️\n•ยินดีต้อนรับสู่ห้อง\n 🔛 " + str(ginfo.name) + " " + "\n\n•by : SELFBOT TOME↔BOTLINE")
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            cl.sendMessage(c) 
            cl.sendImageWithURL(op.param1,image)
...
#==============================================================================#
        if op.type == 17:
          if wait["acommentOn"] == True:
            ...
            contact = cl.getContact(op.param2)
            image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1,"สวัสดีครับผม\n" + "↪" + cl.getContact(op.param2).displayName + "↩️\n " + str(wait["acomment"]) + " " + "\n•by : SELFBOTTOME↔BOTLINE")
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            cl.sendMessage(c) 
            cl.sendImageWithURL(op.param1,image)
        ...
        if op.type == 15:
          if wait["bcommentOn"] == True:
            if op.param2 in Bots:
                return
            contact = cl.getContact(op.param2)
            image = "http://di.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + str(wait["bcomment"]) + "\n\nBy.TOME😈BOTLINE")
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            cl.sendMessage(c)
